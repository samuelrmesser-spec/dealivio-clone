      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center space-x-2">
              <span className="text-xl font-bold">DEALIVIO</span>
            </Link>
            <p className="text-sm text-muted-foreground max-w-xs">
              Discover the latest trends, products, and lifestyle inspiration to enhance your everyday life. Your
              trusted source for quality content across multiple categories.
            </p>
        ...
        <div className="mt-12 pt-8 border-t">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-muted-foreground">© 2024 Dealivio. All rights reserved.</p>
